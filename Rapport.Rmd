...
Les arbres ont été crées via la fonction `rpart` avec l'indice de gini. Pour ce qui est de l'arbre élagué nous avons utilisé la fonction `prune`.
```{r eval=FALSE}
...
Table: taux d'erreurs moyen (validation croisée 10 plis)
