...
![Résultats des modèles pour le dataset `Phonèmes`](resultats_phonemes.jpeg){width=70%}
...
Ainsi, en conclusion, nous choisissons la **RDA** avec les paramètres $\bar{\lambda}$ = 0.83 et $\bar{\alpha}$ = 0.29.
...
![MSE en fonction de C](MSE en fonction de C.png){width=55%} 
