...
![Corrélation X1 à X8](corre1.png){width=20%} 
![Corrélation X9 à X16](corre2.png){width=20%} 
...
![Importances des variables, forêt aléaroire](rf_letter.png){width=30%} 
...
Le résaux de neurones à été genéré grâce au package "nnet" de la façon suivante :
```{r eval=FALSE}
